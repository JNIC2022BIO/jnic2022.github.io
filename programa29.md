  ...
  <tbody valign="top">
    ...
    <tr>
      ...
      <td colspan="2">
        ...
        <br>
         Organizada por: <a href="http://www.pesi-seguridadindustrial.org/es" target="_blank"><img style="max-height:75px; padding:20px;" src="/Logos/pesi.png"></a> <a href="https://www.cybasque.eus/home-cybasque" target="_blank"><img style="max-height:70px; padding:25px;" src="/images/patrocinadores/CYBASQUE.png"></a>  <a href="https://www.accenture.com/es-es" target="_blank"><img style="max-height:70px; padding:20px;" src="{{site.url}}/images/patrocinadores/Accenture.png"></a>
        <br>
        </td>
    </tr>
    <tr>
